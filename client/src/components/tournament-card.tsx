    ...
    <Card className="group relative w-full bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border-0 overflow-hidden">
      ...
      <CardContent className="p-6">
        ...
        <div className="flex gap-2 mb-4">
          <div className="flex-1 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-2 border border-green-100">
          ...
          <div className="flex-1 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-2 border border-blue-100">
            <div className="flex items-center gap-1 mb-1">
          ...
          <div className="flex-1 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-2 border border-orange-100">
            <div className="flex items-center gap-1 mb-1">
